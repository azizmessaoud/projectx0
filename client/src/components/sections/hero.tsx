      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-4xl">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold font-heading leading-[1.1] mb-6 tracking-tight text-white"
          >
          ...
          >
            <a 
              href="#projects"
              className="px-8 py-4 bg-primary hover:bg-primary/90 text-white rounded-lg font-bold transition-all flex items-center gap-2 group shadow-lg shadow-primary/25"
            >
              View My Work
          ...
          >
            <div className="flex flex-wrap gap-6 text-muted-foreground">
              <a href="https://linkedin.com/in/azizmessaoud" target="_blank" className="hover:text-secondary transition-colors flex items-center gap-2">
                <Linkedin className="w-5 h-5" /> <span className="text-sm">LinkedIn</span>
              </a>
              <a href="https://github.com/azizmessaoud" target="_blank" className="hover:text-secondary transition-colors flex items-center gap-2">
                <Github className="w-5 h-5" /> <span className="text-sm">GitHub</span>
              </a>
              <a href="mailto:aziz.messaoud@esprit.tn" className="hover:text-secondary transition-colors flex items-center gap-2">
